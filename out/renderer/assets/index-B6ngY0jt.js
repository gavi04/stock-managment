...
function AuthForm({ onLogin, onBootstrap, needsBootstrap, busy }) {
  ...
  const schema2 = mode === "bootstrap" ? bootstrapSchema : loginSchema;
  const {
    register,
    handleSubmit,
    formState: { errors }
...
function AppShell({ navigation, activeKey, onNavigate, headerTitle, children, onLogout, user }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "erp-layout", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "sidebar", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-footer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: user?.fullName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "ghost-btn", onClick: onLogout, children: "Logout" })
      ] })
    ] }),
...
function MasterPanel({ type, title, rows, onCreate, onDelete }) {
  const schema2 = reactExports.useMemo(() => schemas[type], [type]);
  const defaultValues2 = reactExports.useMemo(() => defaults[type], [type]);
  const {
    register,
    handleSubmit,
    reset,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "master-layout", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "inline-form", onSubmit: handleSubmit(submit), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Code",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("code") }),
          errors.code ? /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: errors.code.message }) : null
        ] }),
        type === "product" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
            "Barcode",
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("barcode") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
            "Reorder Level",
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", step: "0.001", ...register("min_stock") })
          ] })
        ] }) : null,
        type === "party" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
            "Type",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { ...register("type"), children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
            "Phone",
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("phone") })
          ] })
        ] }) : null,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: type === "product" ? "Barcode" : "Type" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Action" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 4, children: "No data found." }) }) : rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.code }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: type === "product" ? row.barcode || "-" : row.type }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "danger-btn", onClick: () => onDelete(row.id), children: "Delete" }) })
        ] }, row.id)) })
      ] })
    ] })
  ] });
...
function VoucherEntryPanel({ title, products, parties, onSubmitVoucher, sign = 1, transactionType }) {
  const [recentVouchers, setRecentVouchers] = reactExports.useState([]);
  const [availableStock, setAvailableStock] = reactExports.useState(0);
  const [loadingStock, setLoadingStock] = reactExports.useState(false);
  const defaultValues2 = reactExports.useMemo(
    () => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "voucher-entry-view", style: { display: "grid", gap: "14px", minWidth: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "inline-form", onSubmit: handleSubmit(submit), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Product",
          /* @__PURE__ */ jsxRuntimeExports.jsx("select", { ...register("product_id"), children: products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: product.id, children: [
            product.name,
            " (",
            product.code,
            ")"
          ] }, product.id)) }),
          errors.product_id ? /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: errors.product_id.message }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Party",
          /* @__PURE__ */ jsxRuntimeExports.jsx("select", { ...register("party_id"), children: parties.map((party) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: party.id, children: party.name }, party.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Quantity",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "number",
              step: "0.001",
              max: sign < 0 ? availableStock : void 0,
              ...register("quantity")
            }
          ),
          sign < 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "stock-hint", children: loadingStock ? "Loading available stock..." : `Available stock: ${Number(availableStock).toFixed(3)}${selectedProduct ? ` for ${selectedProduct.name}` : ""}` }) : null,
          errors.quantity ? /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: errors.quantity.message }) : null
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Rate",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", step: "0.01", ...register("rate") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Notes",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { ...register("notes") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Post Voucher" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", style: { marginTop: "14px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { children: [
        "Recent ",
        title,
        "s"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Item" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Party" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Qty / Total" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: recentVouchers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, children: "No recent vouchers found." }) }) : recentVouchers.map((voucher) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: voucher.voucher_no }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: new Date(voucher.date).toLocaleString() }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: voucher.item || "-" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: voucher.party }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: Number(voucher.total).toFixed(2) })
        ] }, voucher.voucher_no)) })
      ] })
...
const stockMasterSchema = objectType({
  ...
  opening_rate: coerce.number().min(0).default(0),
  opening_date: stringType().optional().default(""),
  min_stock: coerce.number().min(0).default(0),
  is_active: enumType(["1", "0"]).default("1"),
  isi_marked: booleanType().default(false)
});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "stock-master-view", children: [
    ...
    showForm ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel stock-form-panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "stock-grid-form", onSubmit: handleSubmit(submit), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Opening Stock Rate",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", step: "0.01", ...register("opening_rate") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Reorder Level",
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", step: "0.001", ...register("min_stock") })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { children: [
          "Status",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { ...register("is_active"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "1", children: "Active" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "0", children: "Inactive" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "checkbox-label", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", ...register("isi_marked") }),
          "ISI Marked"
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "stock-master-filters", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: categoryFilter, onChange: (event) => setCategoryFilter(event.target.value), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Current Stock" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Reorder Lvl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "Action" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, children: "No items found." }) }) : rows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.code }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.name }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: Number(row.min_stock ?? 0).toFixed(3) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: Number(row.is_active ?? 1) === 1 ? "Active" : "Inactive" }),
